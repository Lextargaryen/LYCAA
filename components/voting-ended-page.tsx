    ...
    <div className="min-h-screen bg-background">
      ...
      <section className={`pt-12 pb-16 px-4 sm:px-6 lg:px-8 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0'}`}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="w-full h-50 sm:h-800 lg:h-900 rounded-lg bg-gradient-to-br from-light-gray via-background to-white border border-border flex items-center justify-center overflow-hidden relative">
            <img 
